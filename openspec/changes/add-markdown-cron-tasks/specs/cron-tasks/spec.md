...
### Requirement: YAML Cron Task Configuration

**Reason**: Replaced by Markdown-based task configuration in `cron/` directory.

**Migration**: Move cron task definitions from `config.yaml` to individual Markdown files in `cron/`.
